...
import { createHooks } from "C:/my-app/nuxt-board/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/my-app/nuxt-board/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "C:/my-app/nuxt-board/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, RouterView } from "vue-router";
import { toRouteMatcher, createRouter } from "C:/my-app/nuxt-board/node_modules/radix3/dist/index.mjs";
import { defu } from "C:/my-app/nuxt-board/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "C:/my-app/nuxt-board/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-B_5pL6RW.js")
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/register-mb7LFp3S.js")
  },
  {
    name: "board-id",
    path: "/board/:id()",
    component: () => import("./_nuxt/_id_-CbTa5eSG.js")
  },
  {
    name: "board-list",
    path: "/board/list",
    component: () => import("./_nuxt/list-B7GGBsOa.js")
  },
  {
    name: "board-write",
    path: "/board/write",
    component: () => import("./_nuxt/write-Czz66_i7.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-D-wkeYlW.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BnpTQa-P.js"));
