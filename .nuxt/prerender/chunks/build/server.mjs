...
import { getContext, executeAsync } from 'file://C:/my-app/nuxt-board/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file://C:/my-app/nuxt-board/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/my-app/nuxt-board/node_modules/vue-router/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://C:/my-app/nuxt-board/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://C:/my-app/nuxt-board/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://C:/my-app/nuxt-board/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/my-app/nuxt-board/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./index-B_5pL6RW.mjs')
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta || {},
    component: () => import('./register-mb7LFp3S.mjs')
  },
  {
    name: "board-id",
    path: "/board/:id()",
    component: () => import('./_id_-CbTa5eSG.mjs')
  },
  {
    name: "board-list",
    path: "/board/list",
    component: () => import('./list-B7GGBsOa.mjs')
  },
  {
    name: "board-write",
    path: "/board/write",
    component: () => import('./write-Czz66_i7.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D-wkeYlW.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BnpTQa-P.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useRoute as d, entry_default as default, asyncDataDefaults as e, createError as f, fetchDefaults as g, useRequestFetch as h, useRequestEvent as i, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
